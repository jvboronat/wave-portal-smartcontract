...
contract WavePortal {
    ...
    // It is called stat varible. It's stored permanently in contract storage
    // It's automatically inicialiced to zero
    uint256 totalWaves;
    ...
    function wave(string memory _message) public {
        ...
        // msg.sender is the person who called the function
        // We could use this to secure the functions
        console.log(msg.sender, "waved s/ message");
